...
const ACCENT_RINGS: Record<NonNullable<TerminalCardProps["accent"]>, string> = {
  ...
  violet: "hover:border-violet/40 hover:shadow-[0_0_30px_-8px_rgba(123,44,191,0.5)]",
  mauve: "hover:border-mauve/40 hover:shadow-[0_0_30px_-8px_rgba(199,125,255,0.45)]",
};
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 border-b border-white/10 bg-gradient-to-r from-white/[0.04] to-transparent px-4 py-2.5 font-mono text-[11px] text-white/50">
        ...
        <span className="ml-auto hidden shrink-0 text-white/25 sm:inline">bash — tty1</span>
      </div>
